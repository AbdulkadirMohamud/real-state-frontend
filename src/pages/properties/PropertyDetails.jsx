                    ...
                    <div className="flex flex-col gap-3 md:flex-row justify-between">
                      <Group>
                        ...
                        <div style={{ flex: 1 }}>
                          <Text size="sm" fw={500}>
                            {property.owner.name}{" "}
                            {property.owner._id === user._id && "(You)"}
                          </Text>
                      ...
                      {property.owner._id !== user._id ? (
                        <div className="flex flex-col gap-3 md:flex-row mt-3 md:mt-0">
                          <Link
                            to={`/property/${property._id}/contact/owner`}
                        ...
                        <div className="flex flex-col gap-3 md:flex-row mt-3 md:mt-0">
                          <Link
                            to={`/edit-property/${property._id}/${property.title
                              .toLowerCase()
                              .split(" ")
                              .join("-")}`}
                            className="w-full flex md:w-auto"
                          ...
                          <button
                            ...
                            className="bg-red-500 px-4 py-3 text-sm flex items-center justify-center rounded-xl text-white duration-100 hover:scale-105"
                          >
                            Delete Property
                          </button>
                        </div>
