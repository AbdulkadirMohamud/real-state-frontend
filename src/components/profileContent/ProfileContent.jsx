...
function ProfileContent() {
  ...
  return (
    <div className="w-full md:w-2/4 xl:w-1/3 p-6 sm:p-8 rounded-lg flex flex-col shadow-[0px_0px_6px_rgb(0,0,0,0.1)]">
      ...
      <button onClick={handleLogout} className="mt-3 w-full bg-red-500 bg-opacity-10 border-[1px] border-red-500 text-red-500 hover:bg-opacity-20 px-4 py-3 text-sm flex items-center justify-center rounded-xl duration-100 ">
        Logout
      </button>
    </div>
  );
